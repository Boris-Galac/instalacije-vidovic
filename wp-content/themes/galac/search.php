...
<main class="main main-proizvod header-padding">
    <div class="upper-header upper-header--search">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-link breadcrumb-link--active">Pretraga</span>
            </div>
            <h1 class="category-heading">Pretraga</h1>
        </div>
    </div>
    <section class="proizvod">
        <div class="container">
            ...
            if(have_posts()){
                while ( have_posts() ) {
                    the_post();
                             get_template_part('template-parts/content', 'product-mini');
                    } wp_reset_postdata(); ?>
                    <?php } ?>
                </div>
                <?php get_sidebar() ?>
