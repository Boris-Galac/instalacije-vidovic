<section class="contact" id="contact">
    <div class="container">
        <h2 class="h2-heading">javite nam se</h2>
        <div class="contact__wrapper">
            <div class="contact__row">
                <!-- <form class="contact-form">
                    <div class="contact-form__row">
                        <label for="name" class="contact-form__label">Vaše ime i prezime</label>
                        <input id="name" type="text" placeholder="Upišite Vaše ime i prezime" />
                    </div>
                    <div class="contact-form__row">
                        <label for="email" class="contact-form__label">Vaš email adresa</label>
                        <input id="email" type="email" placeholder="Upišite Vašu email adresu" />
                    </div>
                    <div class="contact-form__row">
                        <label for="textarea">Vaša poruka</label>
                        <textarea name="textarea" id="textarea" cols="30" rows="10"
                            placeholder="Ostavite Vašu poruku..."></textarea>
                    </div>
                    <input class="contact-form__submit-btn" role="button" type="submit" value="Pošaljite mail" />
                </form> -->
                <p class="contact__first-paragraph">Ukoliko imate neki upit vezano za naše usluge, ili trebate možda
