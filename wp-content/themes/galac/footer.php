        ...
        <div class="footer__wrapper">
            <a href="#" class="footer__logo-wrapper">
                <div aria-label="footer">
                    <img src="/wp-content/themes/galac/src/assets/icons/footer-logo.svg" alt="footer logo" />
                </div>
            </a>
                    ...
                    <div class="footer__col">
                        <div class="contact-info-footer-row">
                            <a href="#"><img src="/wp-content/themes/galac/src/assets/icons/phone-icon.svg"
                                    alt="phone icon" />
                                +385 98 927 4766</a>
                            <a href="#"><img src="/wp-content/themes/galac/src/assets/icons/location-icon.svg"
                                    alt="phone icon" />
                ...
                <div class="footer__row">
                    ...
                    <div class="footer__col footer__col--last-col">
                        <div class="footer__regulativa-wrapper">
                            <a href="#" class="footer__link">Pravila privatnosti</a>
